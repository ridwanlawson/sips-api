...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create("tph", function (Blueprint $table) {
            ...
            $table->integer("tahuntanam")->nullable();
            $table->decimal("bjr", 8, 2)->nullable();
            $table->string("created_by")->nullable();
            $table->string("updated_by")->nullable();
            $table->timestamps();
        });
        ...
        Schema::create("attendance", function (Blueprint $table) {
            ...
            $table->string("section_destination", 20)->nullable();
            $table->string("kemandoran", 10);
        ...
        Schema::create("harvesting", function (Blueprint $table) {
            ...
            $table->string("fcba", 10);
            $table->string("afdeling_destination", 20);
            $table->string("fcba_destination", 10);
            $table->string("kemandoran", 10);
            $table->string("id_device", 100)->nullable();
