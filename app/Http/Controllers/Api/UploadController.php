...
class UploadController extends Controller
{
            ...
            if (Auth::user()->level === "MDP") {
                ...
                $conn->statement(
                    ...
                    INSERT INTO SIPSMOBILE.LHM_DATA (
                        ...
                        TOTALRPPREMI,
                        KURANGBASIS, HARILIBUR, TOTALBRD, RATE_BRONDOLAN,
                        RPHK, BRD_RP, TOTAL,
                        ATTENDANCE_UPLOAD,
                        ...
                        FCENTRY, FCEDIT, FCIP, LASTUPDATE, LASTTIME, RATE_BRONDOLAN_UPLOAD, LASTAPPROVAL
                    )
                    SELECT
                        v.ID,
                        v.ROWDATA,
                ...
                $conn->statement("
                    ...
                    WHERE EXISTS (
                        SELECT 1 FROM SIPSMOBILE.LHM_DATA l
                        WHERE l.ID = a.ID
                    )
                ");
     ...
     * @response 500 scenario="error" {
     *  "success": false,
     *  "message": "Terjadi kesalahan saat menyimpan data. Silakan coba lagis.",
     *  "error": "Deskripsi error dari database"
     * }
     */
